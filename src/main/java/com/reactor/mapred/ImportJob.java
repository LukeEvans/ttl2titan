...
public class ImportJob {
	...
	public static final String RAW_SUBDIR_NAME = "raw";
	...
	private void runImport(RDFJobOptions options, boolean printConfig) throws IOException, ClassNotFoundException, InterruptedException {
